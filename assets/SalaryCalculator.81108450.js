import{r as u,i as y,j as t,a1 as d,H as m,a2 as g,K as x,a3 as h}from"./vendor.3291ae0a.js";import{u as T}from"./index.1ccf0dd0.js";const k=e=>{const l=e*.14,s=e*.01,c=e*.00759,r=e-l-s;let i=0,n="";return r<=158e3?(i=r*.15,n=`%15 gelir vergisi diliminde (${r.toFixed(2)} TL \xFCzerinden)`):r<=33e4?(i=158e3*.15+(r-158e3)*.2,n=`\u0130lk 158.000 TL i\xE7in %15, kalan ${(r-158e3).toFixed(2)} TL i\xE7in %20 gelir vergisi`):(n="Kademeli vergi dilimleri uyguland\u0131.",i=158e3*.15+(33e4-158e3)*.2+(r-33e4)*.27),{net:e-l-s-c-i,explanation:`
  ...
  \u27A4 Damga Vergisi (%0.759): ${c.toFixed(2)} TL
